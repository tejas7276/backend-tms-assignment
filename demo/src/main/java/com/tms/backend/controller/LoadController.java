...
public class LoadController {
    ...
    @GetMapping("/{loadId}/best-offers")
    public List<Bid> bestOffers(@PathVariable UUID loadId) {
        return loadService.getBestOffers(loadId);
    }
